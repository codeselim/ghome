...
require(['jquery', /*'prejqm',*/ 'sseListener', 'device_management', 'new_device', 'scheduler', 'utils',  'stats', 'jquerymobile'], 
	function($, /*_,*/ sseListener, devMgmt, new_device, scheduler, utils, stats) {
