...
start_tests[1] = function (req, res, params, testid) {
	...
	res.end(JSON.stringify({'testid': testid, hideafter: 3000, msg: "Veuillez maintenant appuyer sur le bouton LRN de votre capteur." }))
}
//* Action for device of type 2 
...
start_tests[5] = function (req, res, params, testid) {
	...
	res.end(JSON.stringify({'testid': testid, hideafter: 3000, msg: "Votre prise va être mise en état ON pendant 7 secondes puis éteinte." }))
}
//* Action for device of type 2 
